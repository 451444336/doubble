...
import com.born.util.encrypt.security.support.Hex;
import com.born.util.encrypt.security.support.SecurityCoder;

/**
 * 
 * @ClassName: HmacCoder
 * @Description: HMAC加密组件
 * @author 张永胜
 * @date 2018年5月9日 下午3:06:12
 * @version 1.0
 */
